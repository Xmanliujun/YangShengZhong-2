...
@interface MyudViewController ()

@end

@implementation MyudViewController
...
-(void)httpMifang
{
    ...
    NSString * stringUrl = @"http://www.tripg.com/health/admin/y_yangsheng/search_news_list/13";
    NSLog(@"url %@ ",stringUrl);
