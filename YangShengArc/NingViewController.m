...
@interface NingViewController ()

@end

@implementation NingViewController
...
-(void)httpMifang
{
    ...
    NSString * stringUrl = @"http://www.tripg.com/health/admin/y_yangsheng/search_news_list/16";
