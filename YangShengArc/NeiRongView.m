...
-(id)initWithFloat:(CGFloat)mfloat
{
    ...
    if (self) {
        ...
        if (mfloat >480  ) {
            ...
            self.labBiaoti.font = [UIFont fontWithName:@"Arial" size:20];
...
//            self.labJieshao.font = [UIFont fontWithName:@"Airal" size:12];
...
//            self.labNeirong.frame = CGRectMake(20, 205, 280, 200);
//            self.labNeirong.textColor = [UIColor grayColor];
//            self.labNeirong.textAlignment = NSTextAlignmentLeft;
//            self.labNeirong.font = [UIFont fontWithName:@"Arial" size:13];
