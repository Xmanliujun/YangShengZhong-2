...
@interface MpianViewController ()

@end

@implementation MpianViewController
...
-(void)httpMifang
{
    ...
    NSString * stringUrl = @"http://www.tripg.com/health/admin/y_yangsheng/search_news_list/15";
