...
@interface MshiViewController ()

@end

@implementation MshiViewController
...
-(void)httpMifang
{
    ...
    NSString * stringUrl = @"http://www.tripg.com/health/admin/y_yangsheng/search_news_list/17/1";
